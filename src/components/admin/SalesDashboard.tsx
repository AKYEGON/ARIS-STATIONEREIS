                ...
                <TableBody>
                  {topProducts.map((product, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell className="text-xs sm:text-sm p-2 sm:p-4">KSh {product.total_revenue.toFixed(0)}</TableCell>
                      {!hideProfitData && (
                ...
                <TableBody>
                  {dailySales.map((day, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell className="text-xs sm:text-sm p-2 sm:p-4">KSh {day.total_sales.toFixed(0)}</TableCell>
                      {!hideProfitData && (
                        <TableCell className="text-green-600 font-medium text-xs sm:text-sm p-2 sm:p-4">
